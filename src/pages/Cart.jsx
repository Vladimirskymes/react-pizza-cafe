...
<path d="M11.6666 9.16667V14.1667" stroke="#B6B6B6" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
           ...
           <div className="content__items">
             { addedPizzas.map((obj)=> 
               <CartItem onMinusItems={onMinusItems} onPlusItems={onPlusItems} onDeleteItem = {onDeleteItem} key={obj.id} totalCount={items[obj.id].items.length} totalPrice={items[obj.id].totalPrice} id = {obj.id} name={obj.name} size={obj.size} type={obj.type} imageUrl={obj.imageUrl}/>
               )
             }
